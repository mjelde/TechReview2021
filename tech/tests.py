...
class TechTypeTest(TestCase):
    def setUp(self):
        self.type=TechType(typename='HP Laptop')

    def test_typestring(self):
        self.assertEqual(str(self.type), 'HP Laptop')
...
class ProductTest(TestCase):
    def setUp(self):
        ...
        self.product=Product(productname='HP Elitebook', producttype=self.type, user=self.user, dateentered=datetime.date(2021,2,27), price=1200.99, producturl='http://www.hp.com', description="HP Elitebook")
